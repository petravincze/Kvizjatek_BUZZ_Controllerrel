...
#
#
print("Adjátok meg, hányan szeretnétek játszani, a megfelelő szám beírásával! (1, 2, vagy 3)")
#
#
#
JatekosDb = input()  # csak az elso harom gomb lehet
JatekosDb = int(JatekosDb)
#
#
#
...
#
#
Temakor = input()  # csak az elso ket gomb lehet
Temakor = int(Temakor)
#
#
#
...
if Temakor == 1:
  ...
  #
  #
  Tema = input()  # csak az elso ket gomb lehet
  Tema = int(Tema)
  #
  #
  #
...
for qaItem in qaList:
  ...
  #   print("1. játékos: Nem jól írtad be. Kérlek írd be a szerinted helyes válasz sorszámát:")
  #   #
  #   #
  #   #
  #   userAnsw = input()
  ...
  #   print("1. játékos: Ez nem megfelelő szám. Kérlek írd be a szerinted helyes válasz sorszámát:")
  #   userAnsw = input()
  #   #
  #   #
  #   #
  if possible[userAnsw-1] == qaItem.corrAnsw:
    # print("1. játékos: Helyes a válaszod!")
    corrCountA += 1
  # else:
    # print("1. játékos: Sajnos rossz választ adtál.")
    # print("A helyes válasz a következő lett volna: " + qaItem.corrAnsw)
  print("")
  ...
  if JatekosDb > 1:
    ...
    #
    # while not userAnsw.isdigit():
    #   print("2. játékos: Nem jól írtad be. Kérlek írd be a szerinted helyes válasz sorszámát:")
    #   #
    #   #
    #   #
    #   userAnsw = input()
    # userAnsw = int(userAnsw)
    # while not (userAnsw > 0 and userAnsw <= len(possible)):
    #   print("2. játékos: Ez nem megfelelő szám. Kérlek írd be a szerinted helyes válasz sorszámát:")
    #   #
    #   #
    #   #
    #   userAnsw = input()
    if possible[userAnsw - 1] == qaItem.corrAnsw:
      # print("2. játékos: Helyes a válaszod!")
      corrCountB += 1
    # else:
    # print("2. játékos: Sajnos rossz választ adtál.")
    # print("A helyes válasz a következő lett volna: " + qaItem.corrAnsw)
    print("")
  ...
  if JatekosDb > 2:
    ...
    #
    # while not userAnsw.isdigit():
    #   print("3. játékos: Nem jól írtad be. Kérlek írd be a szerinted helyes válasz sorszámát:")
    #   #
    #   #
    #   #
    #   userAnsw = input()
    # userAnsw = int(userAnsw)
    # while not (userAnsw > 0 and userAnsw <= len(possible)):
    #   print("3. játékos: Ez nem megfelelő szám. Kérlek írd be a szerinted helyes válasz sorszámát:")
    #   #
    #   #
    #   #
    #   userAnsw = input()
    if possible[userAnsw - 1] == qaItem.corrAnsw:
      # print("3. játékos: Helyes a válaszod!")
      corrCountC += 1
    # else:
    # print("3. játékos: Sajnos rossz választ adtál.")
    # print("A helyes válasz a következő lett volna: " + qaItem.corrAnsw)
    print("")
